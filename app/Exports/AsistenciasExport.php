...
class AsistenciasExport implements FromView, WithStrictNullComparison, ShouldAutoSize, WithEvents,
WithColumnFormatting{
    ...
    public function __construct($fecha,$grupo) {
        $this->values = AlumnoAsistencia::whereDate('fecha',$fecha)->with('alumno')->get();
    }

    public function view(): View
    {
        return view("excel.asistencias",["asistencias"=>$this->values,"grupo"=>$this->grupoValue]);
    }

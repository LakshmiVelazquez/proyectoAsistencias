...
class GruposExport implements FromView, WithStrictNullComparison, ShouldAutoSize, WithEvents,
WithColumnFormatting{
    ...
    public function __construct() {
        $this->values = Grupo::where('estatus','A')->get();
    }

    public function view(): View
    {
        return view("excel.grupos",["grupos"=>$this->values]);
    }

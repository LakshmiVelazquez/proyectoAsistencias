...
class MaestrosExport implements FromView, WithStrictNullComparison, ShouldAutoSize, WithEvents,
WithColumnFormatting{
    ...
    public function __construct() {
        $this->values = Maestro::where('estatus','A')->get();
    }

    public function view(): View
    {
        return view("excel.maestros",["maestros"=>$this->values]);
    }

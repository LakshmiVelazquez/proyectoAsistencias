...
class MateriasExport implements FromView, WithStrictNullComparison, ShouldAutoSize, WithEvents,
WithColumnFormatting{
    ...
    public function __construct() {
        $this->values = Materia::where('estatus','A')->get();
    }

    public function view(): View
    {
        return view("excel.materias",["materias"=>$this->values]);
    }

...
class UsuariosExport implements FromView, WithStrictNullComparison, ShouldAutoSize, WithEvents,
WithColumnFormatting{
    ...
    public function __construct() {
        $this->values = User::where('estatus','A')->get();
    }

    public function view(): View
    {
        return view("excel.usuarios",["usuarios"=>$this->values]);
    }
